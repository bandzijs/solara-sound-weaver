export const translations = {
  lv: {
    ...
    form: {
      ...
      text: "Tavs teksts",
      mood: "Noskaņa",
      moodOptions: ["Pops (Pop)", "Hiphops / Reps (Hip-Hop / Rap)", "Roks (Rock)", "Latīņamerikas mūzika (Latin)", "Elektroniskā deju mūzika (EDM)", "Folk Rock", "Nezinu, palīdzi man"],
      submit: "Sūtīt vārdus",
  ...
  en: {
    ...
    form: {
      ...
      text: "Your text",
      mood: "Mood",
      moodOptions: ["Pop", "Hip-Hop / Rap", "Rock", "Latin", "EDM (Electronic Dance Music)", "Folk Rock", "I'm not sure, help me"],
