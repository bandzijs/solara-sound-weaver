...
import { Instagram, Youtube, Save, Send, type LucideIcon } from "lucide-react";
...
const PLATFORM_META: Record<string, { label: string; Icon: LucideIcon | (() => JSX.Element); placeholder: string }> = {
  youtube: {
    label: "YouTube",
    Icon: Youtube,
